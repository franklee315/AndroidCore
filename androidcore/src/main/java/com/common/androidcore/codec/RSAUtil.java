...
public class RSAUtil {
     ...
     * @throws Exception
     */
    public static String getRSA(String content, String PK) throws Exception {
        String resultString = "";
        byte[] code = RSAUtil.encryptByPublicKey(content.getBytes(), PK.getBytes());
        resultString = Base64Util.encode(code);
    ...
    public static String decode(String str, String privateKey) throws Exception {
        String resultStrng = "";
        byte[] decodeByte = RSAUtil.decryptByPrivateKey(str.getBytes(), privateKey.getBytes());

        resultStrng = Base64Util.encode(decodeByte);
        return resultStrng;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("加密后的数据：" + Base64Util.encode(code1));
        ...
        System.out.println("加密后的数据："+Base64Util.encode(code2));  
